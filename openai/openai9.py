...
def get_completion(prompt):
    ...
    return completion
prompt = (f"Necesito un snippet de código en Python para realizar una consulta SELECT en una base de datos MySQL. Debe incluir manejo de errores y usar la librería SQLAlchemy")
